...
export default function GalleryShowcaseSection() {
  return (
    <section
      id="styles"
      className="section-shell relative mt-6 overflow-hidden px-5 py-12 sm:px-8 sm:py-18 lg:px-12 lg:py-20"
    >
      <video
        className="hero-video pointer-events-none absolute inset-0 z-0 w-full object-cover object-center"
        autoPlay
        loop
        muted
        playsInline
          ...
          <div className="relative z-10">
            <div className="grid gap-3 sm:grid-cols-4">
              {HIGHLIGHTS.map((item) => {
                ...
                return (
                  <div
                    key={item.label}
                    className="rounded-[1.4rem] border-border/60 bg-card px-4 py-4 text-center"
                  >
            ...
            <div className="mt-10">
              ...
              <h2 className="mt-5 font-mono text-5xl font-normal leading-[1.02] tracking-[-0.03em] text-foreground sm:text-6xl lg:text-7xl">
                Mengubah <span className="font-medium text-primary">foto</span>
                <br />
                menjadi seni.
              </h2>
              <p className="mt-6 max-w-xl font-mono text-[0.9375rem] leading-relaxed text-muted-foreground sm:text-base">
                Ubah potret dan momen sehari-hari menjadi pemandangan penuh gaya
                yang kaya dengan kedalaman ala sinema, karakter yang hangat,
                serta sentuhan akhir editorial kelas atas.
              </p>
            </div>

            <div className="mt-10 grid gap-4 border-y border-border/60 py-3 sm:grid-cols-3">

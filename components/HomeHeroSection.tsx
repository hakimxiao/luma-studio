        ...
        <div className="home-hero-copy">
          <h1 className="hero-title home-hero-title">
            <span className="block">
              Transfer gaya dengan fidelitas tinggi.
            </span>
            <span className="home-hero-tagline">
              Satu kali unggah, gambar yang siap dipajang di galeri.
            </span>
          </h1>

          <p className="home-hero-lede">
            Unggah sekali, pilih gaya pilihan, dan dapatkan tampilan baru yang
            estetik.
          </p>
          ...
          <div className="home-hero-ctas">
            ...
            >
              <a href="#how-it-works">Tonton demo hanya 2 menit</a>
            </Button>
          </div>
        </div>
